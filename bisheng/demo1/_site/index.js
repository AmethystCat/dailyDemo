...
var _collect = __webpack_require__(504);
...
var stripAnsi = __webpack_require__(214);
var log = __webpack_require__(216).getLogger('webpack-dev-server');
...
var onSocketMsg = {
  ...
  'log-level': function logLevel(level) {
    var hotCtx = __webpack_require__(224);
...
var map = {
	"./template/Archive": 200,
	"./template/Archive.jsx": 200,
	"./template/Layout": 63,
	"./template/Layout.jsx": 63,
	"./template/NotFound": 135,
	"./template/NotFound.jsx": 135,
	"./template/Post": 201,
	"./template/Post.jsx": 201,
	"./template/TagCloud": 202,
	"./template/TagCloud.jsx": 202
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
};
